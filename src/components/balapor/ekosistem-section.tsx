...
const SERVICES: ServiceCard[] = [
  {
    ...
    description: 'Lapor banjir, jalan rusak, sampah. Tim TeraLoka verifikasi & teruskan ke instansi.',
    href: '/reports',
    status: 'current',
    icon: 'campaign',
  ...
  },
  {
    key: 'sos',
    name: 'SOS Darurat',
    tagline: 'Tap sekali, tim respons',
    description: 'Tombol panic darurat 24/7. Maritime, kebakaran, medis, keamanan, bencana.',
    href: '/sos',
    status: 'live',
    icon: 'emergency',
    colorVar: '--color-balapor',
  ...
  },
  {
    ...
    description: 'Kampanye kemanusiaan transparan. 100% sampai ke mitra penyalur, tracking real-time.',
    href: '/fundraising',
    status: 'active',
