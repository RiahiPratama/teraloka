 ...
 * Update 2026-06-12: 'balaju' kini ServiceKey global (lihat badge.tsx).
 *   Sebelumnya sempat di-extend lokal (ServiceKey | 'balaju'); sekarang
 *   disederhanakan balik ke ServiceKey murni karena balaju sudah global.
