...
/**
 * /owner/funding/financial/fee-remittance/new — Form Submit Setoran Fee
 *
...
function NewFeeRemittanceContent() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      if (json.data.active_submission) {
        ...
        router.replace(`/owner/funding/financial/fee-remittance/${json.data.active_submission.id}`);
        return;
      }
      ...
      if (json.data.total_fee_pending <= 0) {
        ...
        router.replace('/owner/funding/financial/fee-remittance');
        return;
      }
  ...
  useEffect(() => {
    ...
    if (!user) {
      router.push('/login?redirect=/owner/funding/financial/fee-remittance/new');
      return;
    }
    loadData();
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      router.push(`/owner/funding/financial/fee-remittance/${json.data.id}`);
    } catch (err: any) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white rounded-2xl p-6 max-w-md w-full text-center">
          ...
          <Link href="/owner/funding/financial/fee-remittance" className="text-sm text-[#003526] underline">
            Kembali
          </Link>
        </div>
      </div>
