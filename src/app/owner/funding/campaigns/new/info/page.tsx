...
export default function CampaignInfoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f9f9f8]">
      ...
      {/* Hero */}
      <div className="bg-gradient-to-br from-[#003526] via-[#003526] to-[#1B6B4A] px-6 pt-10 pb-10 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-lg px-4 mt-6 pb-24 space-y-4">
