...
import FeeModeSection from '@/components/owner/funding/campaigns/FeeModeSection';
      ...
      <div className="min-h-screen bg-[#f9f9f8] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md mx-auto px-4 pt-10 pb-12">
          ...
          <div className="space-y-2.5 anim-fade-4">
            ...
            <button
              onClick={() => router.push(`/owner/funding/campaigns/${campaign.id}`)}
            ...
            <button
              onClick={() => router.push('/owner/funding/campaigns')}
    ...
    <div className="min-h-screen bg-[#f9f9f8] pb-32">
      ...
      <div className="bg-gradient-to-br from-[#003526] via-[#003526] to-[#1B6B4A] text-white px-4 pt-8 pb-24 relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto relative z-10">
          <Link
            href={`/owner/funding/campaigns/${campaign.id}`}
              ...
              onClick={async () => {
                if (isPendingReview) {
                  ...
                  if (ok) {
                    ...
                    router.push(`/owner/funding/campaigns/${campaign.id}?saved=1`);
                  }
                } else {
