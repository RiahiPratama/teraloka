...
// ═══════════════════════════════════════════════════════════════
// /owner/funding/campaigns/[id]/disbursements/[disbId]/page.tsx
...
export default function OwnerDisbursementDetailPage() {
  ...
  async function handleDelete() {
    ...
    try {
      ...
      router.push(`/owner/funding/campaigns/${campaignId}/disbursements`);
    } catch (err: any) {
        ...
        <div className={`${meta.bg} ${meta.border} border rounded-2xl p-4`}>
          ...
          {isEditable && (
            <div className="mt-3 flex gap-2">
              <Link
                href={`/owner/funding/campaigns/${campaignId}/disbursements/${disbId}/edit`}
