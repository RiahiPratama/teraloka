...
// ═══════════════════════════════════════════════════════════════
// /owner/funding/campaigns/[id]/reports/new/page.tsx
...
export default function OwnerCampaignReportNewPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      router.push(`/owner/funding/campaigns/${campaignId}/reports?created=1`);
    } catch (err: any) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white rounded-2xl p-6 max-w-md w-full text-center">
          ...
          <Link href={`/owner/funding/campaigns/${campaignId}/reports`} className="text-sm text-[#003526] underline">Kembali</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 pb-32">
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center gap-3">
          <Link href={`/owner/funding/campaigns/${campaignId}/reports`} className="p-2 -ml-2 rounded-lg hover:bg-gray-100">
