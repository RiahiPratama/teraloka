...
// ═══════════════════════════════════════════════════════════════
// /owner/campaign/[id]/disbursements/[disbId]/edit/page.tsx
...
export default function OwnerDisbursementEditPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      router.push(`/owner/campaign/${campaignId}/disbursements/${disbId}`);
    } catch (err: any) {
      ...
      <div className="min-h-screen bg-gray-50 pb-28">
        <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
          <div className="max-w-3xl mx-auto px-4 py-3 flex items-center gap-3">
            <Link
              href={`/owner/campaign/${campaignId}/disbursements/${disbId}`}
