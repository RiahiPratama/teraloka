...
/**
 * /owner/campaign/[id]/donations — Per-Campaign Donations View
 * 
 * Penggalang dedicated page untuk lihat & verify donasi di SATU kampanye.
 * Berbeda dengan /owner/donations (global inbox) — page ini scoped per-campaign.
 * 
 * Filter & smart views:
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {donation.verification_status === 'pending' && (
            <Link
              href={`/owner/donations?id=${donation.id}`}
