...
/**
 * /owner/financial/fee-remittance — Setor Fee Operasional ke TeraLoka
 *
...
function FeeRemittancePageContent() {
  ...
  useEffect(() => {
    ...
    if (!user) {
      router.push('/login?redirect=/owner/financial/fee-remittance');
      return;
    }
    loadData();
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white rounded-2xl p-6 max-w-md w-full text-center">
          ...
          <Link href="/owner/financial" className="text-sm text-[#003526] underline">
    ...
    <div className="min-h-screen bg-gray-50 pb-28">
      ...
      <div className="max-w-3xl mx-auto px-4 py-5 space-y-4">
        ...
        {hasActiveSubmission && pending?.active_submission && (
          <Link
            href={`/owner/financial/fee-remittance/${pending.active_submission.id}`}
...
function RemittanceCard({ r }: { r: RemittanceListItem }) {
  ...
  return (
    <Link
      href={`/owner/financial/fee-remittance/${r.id}`}
