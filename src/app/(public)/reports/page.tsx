...
const FAQ_DATA: { tabs: { id: number; label: string; icon: string }[]; items: Record<number, { id: string; q: string; a: string }[]> } = {
  ...
  items: {
    0: [
      ...
      { id: 'about-5', q: 'Apakah SOS Darurat bisa menggantikan telepon 112?', a: 'Tidak. SOS TeraLoka <strong>menyiarkan</strong> keadaan daruratmu ke tim TeraLoka &amp; warga sekitar — ini bukan layanan tanggap darurat dan tidak menjamin ada yang merespons. Untuk pertolongan nyata, <strong>selalu telepon 112 lebih dulu</strong>. Selengkapnya di <a href="/aturan/balapor/sos" style="color:#EF4444;font-weight:700;text-decoration:underline">Ketentuan SOS Darurat</a>.' },
    ],
    1: [
