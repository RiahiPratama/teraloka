...
const LIFECYCLE_STEPS = [
  ...
  { num: 2, title: 'Verifikasi',         icon: 'verified',     bg: '#EFF6FF', color: '#3B82F6', desc: 'Tim TeraLoka memeriksa kelengkapan, lokasi, dan kategori laporan.' },
...
const FAQ_DATA: { tabs: { id: number; label: string; icon: string }[]; items: Record<number, { id: string; q: string; a: string }[]> } = {
  ...
  items: {
    0: [
      ...
      { id: 'about-4', q: 'Di mana saya bisa baca ketentuan lengkap BALAPOR?', a: 'Ketentuan Layanan BALAPOR — cara kerja, arti verifikasi, anonimitas pelapor, aturan isi laporan, dan tanggung jawab — bisa kamu baca selengkapnya di <a href="/aturan/balapor/ketentuan" style="color:#EF4444;font-weight:700;text-decoration:underline">halaman Ketentuan Layanan BALAPOR</a>.' },
      { id: 'about-5', q: 'Apakah SOS Darurat bisa menggantikan telepon 112?', a: 'SOS <strong>melengkapi</strong>, bukan menggantikan, panggilan darurat resmi. SOS menyiarkan keadaan daruratmu ke tim TeraLoka &amp; warga sekitar supaya lebih banyak yang tahu — sementara untuk pertolongan tercepat, layanan darurat resmi tetap jadi andalan utama. Jadi <strong>telepon 112 lebih dulu</strong>, lalu siarkan lewat SOS. Selengkapnya di <a href="/aturan/balapor/sos" style="color:#EF4444;font-weight:700;text-decoration:underline">Ketentuan SOS Darurat</a>.' },
    ],
    1: [
      ...
      { id: 'priv-2', q: 'Bagaimana jika dipakai untuk fitnah?', a: 'Tim TeraLoka <strong>verifikasi setiap laporan</strong> sebelum naik ke BAKABAR. Cek konsistensi cerita, lokasi GPS, dan foto. Laporan yang mencurigakan ditandai oleh sistem kami, akun bisa diblokir permanen jika terbukti melakukan fitnah.' },
      { id: 'priv-3', q: 'Saya bisa hapus laporan kapan saja?', a: 'Ya. Kamu bisa <strong>request hapus laporan</strong> kapan saja melalui dashboard "Laporan Saya". Tim TeraLoka akan memproses permintaan tersebut sesuai Kebijakan Privasi. Hak privasi sepenuhnya milikmu.' },
    ],
    2: [
      { id: 'how-1', q: 'Berapa lama proses verifikasi laporan?', a: 'Tim TeraLoka berupaya meninjau laporan secepat mungkin, namun tidak menjanjikan jangka waktu tertentu. Status laporan transparan dan bisa kamu pantau real-time. <strong>Penting:</strong> untuk keadaan darurat (kecelakaan, kebakaran, bencana), jangan mengandalkan BALAPOR — hubungi langsung kanal darurat resmi seperti 112.' },
