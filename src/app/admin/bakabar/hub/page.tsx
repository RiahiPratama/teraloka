    ...
    <div style={{ maxWidth: 1100, margin: '0 auto', fontFamily: "'Outfit', system-ui" }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <Link href="/admin/bakabar/hub/new" style={{ fontSize: 13, color: '#fff', fontWeight: 700, textDecoration: 'none', padding: '8px 16px', background: '#1B6B4A', borderRadius: 10 }}>
            + Tulis Cepat
          </Link>
          <Link href="/admin/bakabar" style={{ fontSize: 13, color: t.textMuted, fontWeight: 500, textDecoration: 'none', padding: '7px 12px', background: t.navHover, borderRadius: 10 }}>
            ← Overview
          </Link>
        </div>
      </div>
