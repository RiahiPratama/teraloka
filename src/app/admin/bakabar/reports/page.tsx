  ...
  return (
    <div style={{ maxWidth: 960, margin: '0 auto', fontFamily: "'Outfit', system-ui" }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <Link href="/admin/bakabar/hub" style={{ padding: '5px 12px', borderRadius: 8, fontSize: 12, fontWeight: 600, background: '#0891B2', color: '#fff', textDecoration: 'none' }}>
                  Buka Hub
                </Link>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        ...
        <Link href="/admin/bakabar" style={{ fontSize: 13, color: t.textMuted, fontWeight: 500, textDecoration: 'none', padding: '6px 12px', background: t.navHover, borderRadius: 8 }}>
          ← Overview
        </Link>
      </div>
