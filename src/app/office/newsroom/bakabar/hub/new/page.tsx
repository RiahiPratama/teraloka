...
export default function NewArticlePage() {
    ...
    saveTimer.current = setTimeout(() => {
      try {
        localStorage.setItem(LOCAL_DRAFT_KEY, JSON.stringify({
          title, body, category, coverImageUrl, coverImageCaption, sourceUrl, sourcePlatform, isBreaking, isTrending, source, locationId,
  ...
  }, [title, body, category, coverImageUrl, coverImageCaption, sourceUrl, sourcePlatform, isBreaking, isTrending, source, locationId, draftLoaded]);
  ...
  const handleRestoreDraft = () => {
    ...
    setCoverImageCaption(restorePrompt.coverImageCaption || '');
    ...
    setSource(restorePrompt.source || 'original');
        ...
        {!focusMode && (
          <div style={{
            ...
            <article style={{
              ...
              borderRadius: 14, padding: 28, height: 555, overflowY: 'auto', boxSizing: 'border-box',
